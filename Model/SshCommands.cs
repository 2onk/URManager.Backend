...
namespace URManager.Backend.Model
{
    public class SshCommands
    {
        ...
        public static string FilePathMedia => "/data/programs/";
        //public static string DeleteUpdateFile => "rm /home/ur/Desktop/";
        public static string DeleteUpdateFile => "rm /data/programs/";
